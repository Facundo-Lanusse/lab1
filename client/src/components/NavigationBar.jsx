...
const NavigationBar = () => {
    ...
    const items = [
        { icon: "glass.svg", text: "Communities", path: "/Communities" },
    ...
    const getActiveIndex = () => {
        const exactMatchIndex = items.findIndex(item =>
        ...
        <div className={styles.navigation}>
            ...
            <ul>
                {items.map((item, index) => (
                    ...
                    >
                        <div className={`${styles.iconWrapper} ${index === activeIndex ? styles.activeIcon : ""}`}>
                            <img
                        ...
                        {index === activeIndex && <span className={styles.activeIndicator}></span>}
                    </li>
                ))}
                <div
                    ref={indicatorRef}
